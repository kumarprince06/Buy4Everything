...
export const Images = {
    ...
    /** All Categories screen – filenames as in design */
    categoryFruitsVeg: require('./fruites&Vegitable.png'),
    categoryDairy: require('./fb0a906534f56b9aeed9d1c1b12adf946e5c1c04.png'),
    categoryFishesMeat: require('./fishes&meats.png'),
    categoryHomeCleaning: require('./home&cleaning.png'),
    categoryCooking: require('./cooking-element.png'),
    categorySnacks: require('./snacks-items.png'),
    categoryPersonalCare: require('./personal-care.png'),
    categoryStationery: require('./stationaly&offices.png'),
    categoryKitchen: require('./kitchen-appliance.png'),
    categoryBabyCare: require('./baby-care.png'),
    categoryTeaCoffee: require('./tea-coffee-&more.png'),
    categoryPackagedFood: require('./packaged-food.png'),
    categoryColdDrinks: require('./cold-drink&juices.png'),
    categoryPharmacy: require('./pharmacy&wellness.png'),
    /** Fruits & Vegetables product list (category list screen) */
    productPomegranate: require('./fresho! Pomegranate, 1 kg.png'),
    productMango: require('./Ratnagiri Alphonso Mango - 2 Pc.png'),
    productTomato: require('./Fresh Tomato 1 kg.png'),
    productStrawberry: require('./Fresho Strawberry 200 g.png'),
    productOnion: require('./Onion 5 kg (Pack).png'),
    productCarrot: require('./Carrot Red 500GM.png'),
    productBroccoli: require('./Fresho Broccoli 500 g.png'),
    productCucumber: require('./fresho! Cucumber (Loose), 1 kg.png'),
    productRedPotato: require('./Red Potato(1 kg).png'),
    productLitchi: require('./Fresho Litchi 1 kg.png'),
    productVeggieCombo: require('./Order Healthy & Nutritious Veggie Combo | Shop Online | Pluckk.png'),
    productFruitsVegBox: require('./Fruits & Vegetables Box - Sample » OrganicBasket.jpg'),
    productBanana: require('./banana.png'),
    productApple: require('./apple.png'),
    productPoojaFlowers: require('./flower.png'),
};
